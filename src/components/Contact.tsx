    ...
    >
      ...
      <div className="container mx-auto px-6 max-w-6xl relative z-10">
        ...
        <div className={`max-w-3xl mx-auto transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <form ref={formRef} onSubmit={handleSubmit} className="relative bg-white/80 backdrop-blur-sm p-10 md:p-14 rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.12)] border border-white/50 space-y-8">
            ...
            <div className="relative z-10 space-y-8">
              <div className="group">
                <label htmlFor="name" className="block text-sm font-semibold mb-3 uppercase tracking-wide text-foreground/70 group-focus-within:text-primary transition-colors">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-14 px-5 text-base bg-white border-2 border-gray-200 rounded-lg focus:border-primary focus:ring-0 transition-all hover:border-gray-300 shadow-sm"
                  />
              ...
              <div className="group">
                <label htmlFor="email" className="block text-sm font-semibold mb-3 uppercase tracking-wide text-foreground/70 group-focus-within:text-primary transition-colors">
              ...
              <div className="group">
                <label htmlFor="message" className="block text-sm font-semibold mb-3 uppercase tracking-wide text-foreground/70 group-focus-within:text-primary transition-colors">
                ...
                <div className="relative">
                  <Textarea
                    ...
                    className="min-h-[250px] resize-none px-5 py-4 text-base bg-white border-2 border-gray-200 rounded-lg focus:border-primary focus:ring-0 transition-all hover:border-gray-300 shadow-sm"
                  />
                  <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-primary/0 via-primary/5 to-primary/0 opacity-0 focus-within:opacity-100 transition-opacity pointer-events-none"></div>
                </div>
              </div>
              ...
              <div className="text-right pt-4">
                <Button
                  type="submit"
                  disabled={isSending}
                  className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold px-12 py-6 text-sm uppercase tracking-wider rounded-md shadow-lg hover:shadow-2xl hover:shadow-primary/50 transition-all hover:-translate-y-1 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                >
